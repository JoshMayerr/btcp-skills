Use $skill-creator to create a skill named “analyze-customer-cohorts”.

Download the complete canonical package from:
https://github.com/JoshMayerr/btcp-skills/releases/download/analyze-customer-cohorts-v0.1.0/analyze-customer-cohorts.zip

The canonical SKILL.md is also available at:
https://raw.githubusercontent.com/JoshMayerr/btcp-skills/analyze-customer-cohorts-v0.1.0/skills/analyze-customer-cohorts/SKILL.md

Use $skill-creator to create a skill named “integrate-add-on-acquisition”.

Download the complete canonical package from:
https://github.com/JoshMayerr/btcp-skills/releases/download/integrate-add-on-acquisition-v0.1.0/integrate-add-on-acquisition.zip

The canonical SKILL.md is also available at:
https://raw.githubusercontent.com/JoshMayerr/btcp-skills/integrate-add-on-acquisition-v0.1.0/skills/integrate-add-on-acquisition/SKILL.md

---
name: growth-equity-deal-room
description: Execute evidence-linked growth-equity diligence from uploaded deal materials, including intake, customer/ARR and SaaS analysis, management triangulation, minority-investment models, investment evidence matrices, public research, value creation, hiring, and legal diligence. Use for growth-equity underwriting and deal-room work; not ordinary financial questions, unrelated document editing, or LBOs unless requested.
---

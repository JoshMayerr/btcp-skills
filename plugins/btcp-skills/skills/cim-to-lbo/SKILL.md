---
name: cim-to-lbo
description: "Convert a prior LBO Excel workbook into a new target-company LBO using a CIM, teaser, offering memo, or management presentation. Use when the user provides or references a deal document and an example LBO workbook and wants the deliverable to be nearly identical to that workbook: same tabs, layout, formatting, formulas, schedules, sensitivities, and presentation style, with only new deal-specific numbers, labels, source notes, diligence flags, and necessary line-item changes."
---

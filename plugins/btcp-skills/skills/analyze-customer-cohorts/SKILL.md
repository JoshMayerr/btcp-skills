...
description: Analyze mixed customer data-room materials into an auditable customer-quality, concentration, segmentation, retention, cohort, growth, and pricing assessment. Use when a private equity or diligence analyst needs to extract and resolve customers from spreadsheets, CSVs, contracts, invoices, CRM or billing exports, decks, PDFs, website logo pages, or public sources; calculate logo retention, GRR, NRR, churn, expansion, contraction, new business, cohort evolution, or revenue and ARR concentration; profile customers by industry, business function, size, geography, product, or channel; and produce a customer analysis workbook or investment-style report with evidence lineage and explicit limitations.
---

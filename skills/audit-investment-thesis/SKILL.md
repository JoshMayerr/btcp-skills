...
description: Audit a private equity or investment opportunity against a firm's stated investment thesis and demonstrated historical behavior. Use when an investor needs to interpret a CIM, SIM, teaser, one-pager, inbound, data room, or management materials; learn the mandate from criteria decks, prior IC memos, pass rationales, portfolio history, DealCloud or other CRM records, and operating-advisor work; extract sourced claims; evaluate financial, business-quality, market, management, situation, and differentiation criteria; identify fits, exceptions, diligence gaps, and potential disqualifiers; compare the target with analogous opportunities; and produce an evidence-linked thesis scorecard or screening memo.
---

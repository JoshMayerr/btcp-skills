---
name: standardize-portfolio-financials
description: Standardize messy monthly or quarterly portfolio company financial submissions into a private equity sponsor's reporting format. Use when an analyst needs to inventory heterogeneous Excel, CSV, PDF, or document submissions; normalize periods, units, currencies, signs, accounts, segments, KPIs, or pro forma adjustments; reconcile company and portfolio results; surface errors and missing data; produce auditable company and portfolio workbooks; or create internal-review and LP-ready reporting packages.
---
